var startScreen;
  var gameHTML;
  var counter = 30;
  var questionArray = ["Which beer has the highest alcohol content?", "Which one is the mexican beer?", "What is the primary ingredient for a margarita?", "Highest proof liquor?", "What is the biggest ocean?", "What is the biggest caribbean island?", "What is the main ingredient in a pina colada?", "what is the most populaed fish in caribbean?"];
  var answerArray = [["Sam Adams Utopias", "BrewDog Tactical Nuclear Penguin", "Struise Black Damnation VI", "Schorschbräu Schorschbock"], ["Bud Light", "Hofbräuhaus", "Grolsch", "Pacifico"], ["Vodka", "Rum", "Tequila", "Whisky"], ["Bruichladdich X4 Quadrupled Whisky"," Everclear","Spirytus","Balkan Vodka "], ["Southern Ocean", "Indian Ocean", "Atlantic Ocean", "Pacific Ocean"], ["Cuba","Hispaniola","Jamaica","Puerto Rico"], ["Everclear", "White rum", "Vodka", "Tequila"],
   ["Great Barracuda","Barred Hamlet","Rock Beauty","Queen Angelfish"]];

  var correctAnswers = ["D. Schorschbräu Schorschbock", "D. Pacifico", "C. Tequila", "C. Spirytus", "D. Pacific Ocean", "A. Cuba", "B. White rum", "D. Queen Angelfish"];
